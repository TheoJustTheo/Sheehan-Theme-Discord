...
:root {
	...
	--background:					url(https://media.discordapp.net/attachments/819755030454337537/823422896835526706/Screenshot_7.png?width=1072&height=603;	/* general background image				*/
...
:root {
    ...
    --vaccentcolor:                32, 142, 255;

	--dfont:						Whitney, Helvetica Neue, Helvetica, Arial, sans-serif;
	--dtextshadow:					transparent;

	--dbackground:					url(https://media.discordapp.net/attachments/819755030454337537/823422896835526706/Screenshot_7.png?width=1072&height=603);
...
#app-mount .image-3zK3Wt {									/* app					errorscreen image					*/
	background-image: url(https://media.discordapp.net/attachments/819755030454337537/823422896835526706/Screenshot_7.png?width=1072&height=603);
	opacity: 0.6;
}
...
.channelNotice-1-XFjC.invite-OjTXrW::before {
	opacity: 0.6;
	background: url(https://media.discordapp.net/attachments/819755030454337537/823422896835526706/Screenshot_7.png?width=1072&height=603) center 20px no-repeat;
}
...
.channelNotice-3DDmsB::before {
	opacity: 0.6;
	background: url(https://media.discordapp.net/attachments/819755030454337537/823422896835526706/Screenshot_7.png?width=1072&height=603) center top 20px/153px no-repeat;
}
#app-mount .channelNotice-3hkOiI::before {
	opacity: 0.6;
	background: url(https://media.discordapp.net/attachments/819755030454337537/823422896835526706/Screenshot_7.png?width=1072&height=603) center top 22px/220px no-repeat;
}
...
.icon-2Po-VO[style*="/assets/5da4cdab01d4d89c593c48c62ae0d937.svg"] {		/* systemmessage			pinicon									*/
	-webkit-mask: url(https://media.discordapp.net/attachments/819755030454337537/823422896835526706/Screenshot_7.png?width=1072&height=603) center/cover no-repeat;
...
#app-mount .footerImage-4UrEF0 {
    background-image: url(https://discordapp.com/assets/36d0e0bb009fa362c2533003c0af67b5.svg);
	opacity: 0.6;
}
